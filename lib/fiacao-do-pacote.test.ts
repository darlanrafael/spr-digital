...
const FIACAO: { arquivo: string; trecho: string; porque: string }[] = [
  ...
  { arquivo: 'app/api/terapeutas/vendas/editar-paciente/route.ts', trecho: "from('ocorrencias_prontuario')",
    porque: 'sem a nota, trocar quem e o paciente volta a nao deixar rastro visivel - foi assim que uma paciente foi sobrescrita pela outra em 04/08 e so deu para reconstruir por acidente' },
  { arquivo: 'app/api/terapeutas/vendas/editar-paciente/route.ts', trecho: 'mudouIdentidade',
    porque: 'e a guarda que exige o motivo; sem ela a edicao volta a passar em silencio' },
